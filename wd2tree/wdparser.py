...
class WDParser():
    ...
    def __init__( self, fndata, rLen=1024, dType='H',  isASCII=False, hasHeader=True, compressType=None ):
	  ...
	  if compressType == "bz2":
	    self.__fdata = bz2.BZ2File( fndata, 'r' )
	  elif compressType == "gz":
	    self.__fdata = gzip.GzipFile( fndata, 'r' )
	  else:
